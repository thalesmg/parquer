...
struct_info('geospatialStatistics') ->
  {struct, [{1, {struct, {'parquer_parquet_types', 'boundingBox'}}},
          {2, {list, i32}}]}
;
...
struct_info('timeUnit') ->
  {struct, [{1, {struct, {'parquer_parquet_types', 'milliSeconds'}}},
...
struct_info('logicalType') ->
  {struct, [{1, {struct, {'parquer_parquet_types', 'stringType'}}},
...
struct_info('columnCryptoMetaData') ->
  {struct, [{1, {struct, {'parquer_parquet_types', 'encryptionWithFooterKey'}}},
...
struct_info('rowGroup') ->
  {struct, [{1, {list, {struct, {'parquer_parquet_types', 'columnChunk'}}}},
          {2, i64},
          {3, i64},
...
struct_info('offsetIndex') ->
  {struct, [{1, {list, {struct, {'parquer_parquet_types', 'pageLocation'}}}},
          {2, {list, i64}}]}
;
...
struct_info('encryptionAlgorithm') ->
  {struct, [{1, {struct, {'parquer_parquet_types', 'aesGcmV1'}}},
...
struct_info('fileCryptoMetaData') ->
  {struct, [{1, {struct, {'parquer_parquet_types', 'encryptionAlgorithm'}}},
          {2, string}]}
;
...
struct_info_ext('sizeStatistics') ->
  {struct, [{1, optional, i64, 'unencoded_byte_array_data_bytes', undefined},
          {2, optional, {list, i64}, 'repetition_level_histogram', []},
          {3, optional, {list, i64}, 'definition_level_histogram', []}]}
;

struct_info_ext('boundingBox') ->
  {struct, [{1, required, double, 'xmin', undefined},
...
struct_info_ext('geospatialStatistics') ->
  {struct, [{1, optional, {struct, {'parquer_parquet_types', 'boundingBox'}}, 'bbox', #'boundingBox'{}},
...
struct_info_ext('decimalType') ->
  {struct, [{1, required, i32, 'scale', undefined},
...
struct_info_ext('timeUnit') ->
  {struct, [{1, optional, {struct, {'parquer_parquet_types', 'milliSeconds'}}, 'mILLIS', #'milliSeconds'{}},
          {2, optional, {struct, {'parquer_parquet_types', 'microSeconds'}}, 'mICROS', #'microSeconds'{}},
          {3, optional, {struct, {'parquer_parquet_types', 'nanoSeconds'}}, 'nANOS', #'nanoSeconds'{}}]}
;

struct_info_ext('timestampType') ->
  {struct, [{1, required, bool, 'isAdjustedToUTC', undefined},
...
struct_info_ext('intType') ->
  {struct, [{1, required, byte, 'bitWidth', undefined},
...
struct_info_ext('logicalType') ->
  {struct, [{1, optional, {struct, {'parquer_parquet_types', 'stringType'}}, 'sTRING', #'stringType'{}},
          ...
          {5, optional, {struct, {'parquer_parquet_types', 'decimalType'}}, 'dECIMAL', #'decimalType'{}},
          ...
          {8, optional, {struct, {'parquer_parquet_types', 'timestampType'}}, 'tIMESTAMP', #'timestampType'{}},
          ...
          {15, optional, {struct, {'parquer_parquet_types', 'float16Type'}}, 'fLOAT16', #'float16Type'{}},
          {16, optional, {struct, {'parquer_parquet_types', 'variantType'}}, 'vARIANT', #'variantType'{}},
          {17, optional, {struct, {'parquer_parquet_types', 'geometryType'}}, 'gEOMETRY', #'geometryType'{}},
          {18, optional, {struct, {'parquer_parquet_types', 'geographyType'}}, 'gEOGRAPHY', #'geographyType'{}}]}
;
...
struct_info_ext('schemaElement') ->
  {struct, [{1, optional, i32, 'type', undefined},
          ...
          {10, optional, {struct, {'parquer_parquet_types', 'logicalType'}}, 'logicalType', #'logicalType'{}}]}
;
...
struct_info_ext('dataPageHeader') ->
  {struct, [{1, required, i32, 'num_values', undefined},
          ...
          {5, optional, {struct, {'parquer_parquet_types', 'statistics'}}, 'statistics', #'statistics'{}}]}
;
...
struct_info_ext('dataPageHeaderV2') ->
  {struct, [{1, required, i32, 'num_values', undefined},
          ...
          {8, optional, {struct, {'parquer_parquet_types', 'statistics'}}, 'statistics', #'statistics'{}}]}
;
...
struct_info_ext('bloomFilterAlgorithm') ->
  {struct, [{1, optional, {struct, {'parquer_parquet_types', 'splitBlockAlgorithm'}}, 'bLOCK', #'splitBlockAlgorithm'{}}]}
;
...
struct_info_ext('bloomFilterCompression') ->
  {struct, [{1, optional, {struct, {'parquer_parquet_types', 'uncompressed'}}, 'uNCOMPRESSED', #'uncompressed'{}}]}
;

struct_info_ext('bloomFilterHeader') ->
  {struct, [{1, required, i32, 'numBytes', undefined},
          {2, required, {struct, {'parquer_parquet_types', 'bloomFilterAlgorithm'}}, 'algorithm', #'bloomFilterAlgorithm'{}},
          {3, required, {struct, {'parquer_parquet_types', 'bloomFilterHash'}}, 'hash', #'bloomFilterHash'{}},
          {4, required, {struct, {'parquer_parquet_types', 'bloomFilterCompression'}}, 'compression', #'bloomFilterCompression'{}}]}
;
...
struct_info_ext('pageHeader') ->
  {struct, [{1, required, i32, 'type', undefined},
          ...
          {5, optional, {struct, {'parquer_parquet_types', 'dataPageHeader'}}, 'data_page_header', #'dataPageHeader'{}},
          {6, optional, {struct, {'parquer_parquet_types', 'indexPageHeader'}}, 'index_page_header', #'indexPageHeader'{}},
          {7, optional, {struct, {'parquer_parquet_types', 'dictionaryPageHeader'}}, 'dictionary_page_header', #'dictionaryPageHeader'{}},
          {8, optional, {struct, {'parquer_parquet_types', 'dataPageHeaderV2'}}, 'data_page_header_v2', #'dataPageHeaderV2'{}}]}
;
...
struct_info_ext('columnMetaData') ->
  {struct, [{1, required, i32, 'type', undefined},
          ...
          {12, optional, {struct, {'parquer_parquet_types', 'statistics'}}, 'statistics', #'statistics'{}},
          {13, optional, {list, {struct, {'parquer_parquet_types', 'pageEncodingStats'}}}, 'encoding_stats', []},
          {14, optional, i64, 'bloom_filter_offset', undefined},
          {15, optional, i32, 'bloom_filter_length', undefined},
          {16, optional, {struct, {'parquer_parquet_types', 'sizeStatistics'}}, 'size_statistics', #'sizeStatistics'{}},
          {17, optional, {struct, {'parquer_parquet_types', 'geospatialStatistics'}}, 'geospatial_statistics', #'geospatialStatistics'{}}]}
;
...
struct_info_ext('encryptionWithColumnKey') ->
  {struct, [{1, required, {list, string}, 'path_in_schema', []},
          {2, optional, string, 'key_metadata', undefined}]}
;

struct_info_ext('columnCryptoMetaData') ->
  {struct, [{1, optional, {struct, {'parquer_parquet_types', 'encryptionWithFooterKey'}}, 'eNCRYPTION_WITH_FOOTER_KEY', #'encryptionWithFooterKey'{}},
          {2, optional, {struct, {'parquer_parquet_types', 'encryptionWithColumnKey'}}, 'eNCRYPTION_WITH_COLUMN_KEY', #'encryptionWithColumnKey'{}}]}
;

struct_info_ext('columnChunk') ->
  {struct, [{1, optional, string, 'file_path', undefined},
          {2, required, i64, 'file_offset', 0},
          {3, optional, {struct, {'parquer_parquet_types', 'columnMetaData'}}, 'meta_data', #'columnMetaData'{}},
          ...
          {8, optional, {struct, {'parquer_parquet_types', 'columnCryptoMetaData'}}, 'crypto_metadata', #'columnCryptoMetaData'{}},
          {9, optional, string, 'encrypted_column_metadata', undefined}]}
;

struct_info_ext('rowGroup') ->
  {struct, [{1, required, {list, {struct, {'parquer_parquet_types', 'columnChunk'}}}, 'columns', []},
          {2, required, i64, 'total_byte_size', undefined},
          {3, required, i64, 'num_rows', undefined},
          {4, optional, {list, {struct, {'parquer_parquet_types', 'sortingColumn'}}}, 'sorting_columns', []},
...
struct_info_ext('columnOrder') ->
  {struct, [{1, optional, {struct, {'parquer_parquet_types', 'typeDefinedOrder'}}, 'tYPE_ORDER', #'typeDefinedOrder'{}}]}
;

struct_info_ext('pageLocation') ->
  {struct, [{1, required, i64, 'offset', undefined},
          {2, required, i32, 'compressed_page_size', undefined},
          {3, required, i64, 'first_row_index', undefined}]}
;

struct_info_ext('offsetIndex') ->
  {struct, [{1, required, {list, {struct, {'parquer_parquet_types', 'pageLocation'}}}, 'page_locations', []},
          {2, optional, {list, i64}, 'unencoded_byte_array_data_bytes', []}]}
;

struct_info_ext('columnIndex') ->
  {struct, [{1, required, {list, bool}, 'null_pages', []},
...
struct_info_ext('aesGcmV1') ->
  {struct, [{1, optional, string, 'aad_prefix', undefined},
...
struct_info_ext('encryptionAlgorithm') ->
  {struct, [{1, optional, {struct, {'parquer_parquet_types', 'aesGcmV1'}}, 'aES_GCM_V1', #'aesGcmV1'{}},
          {2, optional, {struct, {'parquer_parquet_types', 'aesGcmCtrV1'}}, 'aES_GCM_CTR_V1', #'aesGcmCtrV1'{}}]}
;
...
struct_info_ext('fileMetaData') ->
  {struct, [{1, required, i32, 'version', undefined},
          ...
          {8, optional, {struct, {'parquer_parquet_types', 'encryptionAlgorithm'}}, 'encryption_algorithm', #'encryptionAlgorithm'{}},
          {9, optional, string, 'footer_signing_key_metadata', undefined}]}
;

struct_info_ext('fileCryptoMetaData') ->
  {struct, [{1, required, {struct, {'parquer_parquet_types', 'encryptionAlgorithm'}}, 'encryption_algorithm', #'encryptionAlgorithm'{}},
          {2, optional, string, 'key_metadata', undefined}]}
;
...
struct_names() ->
  ['sizeStatistics', 'boundingBox', 'geospatialStatistics', 'statistics', 'stringType', 'uUIDType', 'mapType', 'listType', 'enumType', 'dateType', 'float16Type', 'nullType', 'decimalType', 'milliSeconds', 'microSeconds', 'nanoSeconds', 'timeUnit', 'timestampType', 'timeType', 'intType', 'jsonType', 'bsonType', 'variantType', 'geometryType', 'geographyType', 'logicalType', 'schemaElement', 'dataPageHeader', 'indexPageHeader', 'dictionaryPageHeader', 'dataPageHeaderV2', 'splitBlockAlgorithm', 'bloomFilterAlgorithm', 'xxHash', 'bloomFilterHash', 'uncompressed', 'bloomFilterCompression', 'bloomFilterHeader', 'pageHeader', 'keyValue', 'sortingColumn', 'pageEncodingStats', 'columnMetaData', 'encryptionWithFooterKey', 'encryptionWithColumnKey', 'columnCryptoMetaData', 'columnChunk', 'rowGroup', 'typeDefinedOrder', 'columnOrder', 'pageLocation', 'offsetIndex', 'columnIndex', 'aesGcmV1', 'aesGcmCtrV1', 'encryptionAlgorithm', 'fileMetaData', 'fileCryptoMetaData'].
...
enum_names() ->
  ['type', 'convertedType', 'fieldRepetitionType', 'edgeInterpolationAlgorithm', 'encoding', 'compressionCodec', 'pageType', 'boundaryOrder'].
